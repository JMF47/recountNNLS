...
This pacakge provides an interface to apply non-negative least squares (NNLS) towards the estimation of transcript abundances using compressed coverage statistics output by the aligner  *rail*. All of the SRA projects quantified by *rail* and compiled by the *recount2* project can be directly quantified by inputing just the *Sequencing Read Archive* (SRA) project name. Otherwise, users can supply some necessary information as outlined below.
